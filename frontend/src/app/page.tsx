    ...
    >
      <div className="flex flex-col items-center gap-[2vh] w-full">
        ...
        <Image
          ...
          width={100}
          height={100}
          className="absolute top-10 right-20 w-60 rotate-[-15deg]"
          style={{
            filter: `
        ...
        <Image
          ...
          width={100}
          height={100}
          className="absolute bottom-10 right-45 w-65 rotate-[15deg]"
          style={{
            filter: `
            drop-shadow(5px 0 0 white)
            drop-shadow(-5px 0 0 white)
        ...
        <Image
          ...
          width={100}
          height={100}
          className="absolute top-8 left-20 w-60 rotate-[3deg]"
          style={{
            filter: `
            drop-shadow(5px 0 0 white)
            drop-shadow(-5px 0 0 white)
