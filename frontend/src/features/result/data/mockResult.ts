  ...
  details: [
      ...
      top_deviation_metrics: [
        {
          ...
          average: 800,
          deviation: 4.63,
          praise: '瞬時に要点を掴む直感力が光る！スピーディーに判断できる行動力の持ち主。',
        },
        {
          label: '総滞在時間(秒)',
          user: 1.2,
          average: 15.0,
          deviation: 0.92,
          praise: '素早く決断できる行動力がある！テンポよく前に進める推進力の持ち主。',
        },
        {
          label: '決断前迷い(ms)',
          user: 200,
          average: 1200,
          deviation: 0.83,
          praise: '迷わずスパッと決められる決断力がある！自分の判断を信じて動けるタイプ。',
        },
        {
          label: 'マウスブレ(px)',
          user: 45.5,
          average: 12.0,
          deviation: 2.79,
          praise: '全力で操作に集中する熱量がある！エネルギッシュに取り組む姿勢の持ち主。',
        },
      ],
    },
    {
      ...
      metrics: [
        { label: '平均判断時間(ms)', user: 600, average: 1500, category: 'time' },
        { label: 'ルール変更適応(秒)', user: 2.1, average: 5.0, category: 'time' },
        { label: 'システム停止連打(回)', user: 0, average: 3, category: 'mouse' },
        { label: '仕分けミス(回)', user: 1, average: 4, category: 'input' },
        { label: '総仕分け完了数(個)', user: 42, average: 31, category: 'input' },
      ],
      analysis_comment: [
    ...
    },
    {
      ...
      metrics: [
        ...
        { label: '過去ログ遡及(回)', user: 0, average: 1.2, category: 'scroll' },
      ],
      analysis_comment: [
